    ...
    <Flex bgColor={gray80_dark800} flexDirection="column" justifyContent="center" minH="100vh">
      <Box p={20} textAlign="center" mx="auto" w="full" maxW="100rem">
        ...
        <ButtonGroup mt={16} flexWrap="wrap" justifyContent="center" gap={4}>
          ...
          <Button variant="default" size="lg" bgColor="gray.100" color="gray.800"><Icon as={RiGithubFill} mr={2} fontSize="2rem"/> GitHub</Button>
          <Button variant="default" size="lg" bgColor="red.600" color="white"><Icon as={RiNpmjsFill} mr={2}
                                                                                    fontSize="2rem"/> npm</Button>
        </ButtonGroup>
      </Box>
    </Flex>
  )
