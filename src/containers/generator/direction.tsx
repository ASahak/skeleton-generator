...
import { Box, Button, Heading, Icon, Menu, MenuButton, MenuItem, MenuList } from '@chakra-ui/react';
...
const OPTIONS = Object.values(DIRECTION).filter((v) => isNaN(Number(v))).map(e => ({ label: e, value: e }));
export const Direction: FC = () => {
  ...
  return (
    <Box p={4}>
      <Heading variant="medium-title" mb={4}>Direction</Heading>
      <Menu variant="base">
        <MenuButton
          as={Button}
          w="full"
