...
import { DEFAULT_REPEAT_COUNT, REPEAT_COUNT_RANGE } from '@/constants/general-settings';
...
export const RepeatCount: FC = () => {
  const value = useRecoilValue(selectHighlightedNodeGridPropState('repeatCount'));
  ...
  return (
    <Box p={4}>
      <Heading variant="medium-title" mb={4}>Repeat count</Heading>
      <Input
        variant="base"
        value={inputVal}
        onChange={onChange}
