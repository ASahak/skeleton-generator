...
export const WithOpacity: FC = () => {
  const withOpacity = useRecoilValue(selectHighlightedNodeGridPropState('withOpacity'));
  ...
  return (
    <Box p={4}>
      <Checkbox size="lg" isChecked={withOpacity} onChange={onChange}>With opacity</Checkbox>
    </Box>
  )
}